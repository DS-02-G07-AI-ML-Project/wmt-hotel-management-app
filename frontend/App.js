...
import ForgotPasswordScreen from './src/screens/users/ForgotPasswordScreen';
...
function RootNavigator() {
  ...
  const initialHome = role === 'admin' ? 'UsersTab' : 'RoomsTab';
  ...
  return (
    <NavigationContainer>
      {token ? <MainTabs initialRouteName={initialHome} /> : <AuthNavigator />}
    </NavigationContainer>
  );
}
